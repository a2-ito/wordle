...
export default function Tile({
  ...
  const face = "absolute inset-0 flex items-center justify-center border-2";
  ...
  return (
    <div className={base} style={{ animationDelay: `${delayMs}ms` }}>
      {/* 回転する箱 */}
      <div
        className={`transform-style-preserve-3d absolute inset-0 transition-transform duration-500 ${flip ? "rotate-x-180" : ""}`}
      >
        {/* 表 */}
